...
func (generator RepositoryGenerator) generateClient(ctx *genall.GenerationContext, root *loader.Package, _ string, markerConf ClientGenConfig) error {
...
var RepositoryTemplate = template.Must(template.New("object-scaffolding-repository").Parse(`
func NewRepo(
	client Interface,
